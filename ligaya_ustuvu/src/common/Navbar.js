      ...
      <div className="max-w-full mx-auto px-6 sm:px-8 lg:px-12">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="md:hidden flex items-center">
            <button
              onClick={toggleMenu}
              className="inline-flex items-center justify-center p-2 rounded-md text-primary hover:text-secondary hover:bg-accent focus:outline-none transition"
            >
      ...
      <div className={`${isMenuOpen ? 'block' : 'hidden'} md:hidden`}>
        ...
        <div className="pt-4 pb-3 border-t border-gray-200">
          ...
          <div className="px-5 pt-2 pb-2">
            <a
              href="/signup"
              className="bg-secondary text-white px-8 py-2 rounded-full text-sm font-medium shadow transition duration-200 hover:brightness-90 inline-block"
              style={textShadowStyle}
            >
              Sign Up
            </a>
